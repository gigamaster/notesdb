import{j as e,ad as a,e as l}from"./index-BewSTdif.js";import"./vendor-B7FnPyzq.js";const u=({selectedColor:n,onSelect:i,className:o="",mode:r="swatch"})=>e.jsxs("div",{className:`grid grid-cols-11 gap-1 ${o}`,children:[a.map(t=>{const s=n===t;return r==="text"?e.jsx("button",{onClick:()=>i(t),className:`
